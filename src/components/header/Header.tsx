...
function Header({ theme, setTheme }: ThemeProps) {
  ...
  return (
    <div className="sticky top-0 bg-inherit rounded-b-lg flex flex-col md:flex-row items-center flex-wrap justify-between align-middle pb-1 border-solid border-b-2 border-rose-200 dark:border-amber-900">
